/*
  # Fix tools view to properly join criteria

  1. Changes
    - Modify tools_view to properly join criteria_tools table
    - Include all criteria for each tool
    - Ensure rankings and descriptions are included
    - Fix tag aggregation
*/
