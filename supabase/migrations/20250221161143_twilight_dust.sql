/*
  ...
  1. Updates
    ...
    - Adds proper null handling for criteria and tags
...
WITH criteria_array AS (
    ...
    FROM (
        -- Include both regular tools and all non-draft submissions
...
SELECT 
    ...
    END as created_on
FROM (
    -- Include both regular tools and all non-draft submissions in base query
